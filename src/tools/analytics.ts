...
export const analyticsTools = [
  {
    ...
    annotations: { title: "Get response times", readOnlyHint: true, openWorldHint: false },
    description:
  ...
  },
  {
    ...
    annotations: { title: "Get average response time", readOnlyHint: true, openWorldHint: false },
    description:
  ...
  },
  {
    ...
    annotations: { title: "Get daily activity", readOnlyHint: true, openWorldHint: false },
    description:
  ...
  },
  {
    ...
    annotations: { title: "Get closed-thread activity", readOnlyHint: true, openWorldHint: false },
    description:
